...
_BUILT_IN_KOBE_AT2 = (
    ...
    / "infrastructure"
    / "ground_motions"
    # Real PEER record, not the shipped synthetic catalog - kept out of
    # data/ (and out of the built package) pending redistribution-rights
    # confirmation, see reference_data_not_shipped/README.md.
